...
class MovingBall :
    ...
    def __init__ (self, x, y, r, m, color, xv, yv):
        ...
        self.air_resistance_coefficient = 0.997
    ...
    def air_resistance(self):
        self.v.x *= self.air_resistance_coefficient
        self.air_resistance_coefficient = self.air_resistance_coefficient ** 1.008
    ...
    def collide_brick(self, bricks):
        for b in bricks:
            if self.p.x - self.r <= b.x and  self.p.x + self.r >= b.x + b.width and self.p.y > 240:
                return True
            else:
                return False
